...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-surface">
      ...
      <div className={`absolute left-1/4 top-1/3 ${isMobile ? 'w-16 h-16' : 'w-24 h-24'} rounded-xl glass-reflection z-[2] opacity-20`}
        style={{
      ...
      <div className={`absolute right-1/4 bottom-1/3 ${isMobile ? 'w-12 h-12' : 'w-16 h-16'} rounded-xl glass-reflection animate-float-delay z-[2] opacity-20`}
        style={{
      ...
      <div className="w-full max-w-md mx-auto z-10">
        <Card className="rounded-3xl overflow-hidden border border-border-subtle glass-reflection"
              style={{
          ...
          <CardContent className="px-4 py-6 sm:px-6 sm:py-8 flex flex-col items-center text-center">
            ...
            <p className="text-text-secondary mb-6 sm:mb-8 mx-auto text-sm sm:text-base">
            ...
            <Button
              asChild
              className="w-full rounded-full bg-accent-primary text-text-primary font-medium py-5 sm:py-6 text-base sm:text-lg hover:scale-[1.03] hover:brightness-105 transition-all"
            >
