...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-deep-teal">
      {/* Background with warm gradient and grain texture - matching onboarding sequence */}
      ...
      {/* Floating glass orbs - enhanced to match onboarding */}
      ...
      <Card className="max-w-md w-full rounded-3xl overflow-hidden backdrop-blur-md bg-white/15 border border-white/30 shadow-xl relative z-10">
        <CardContent className="px-6 py-8 flex flex-col items-center">
          ...
          {/* Typography - updated with better Brief.me focus */}
          ...
          {/* Call to Action - styled to match onboarding */}
          <Button
            asChild
