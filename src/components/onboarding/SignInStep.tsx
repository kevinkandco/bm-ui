...
const SignInStep = ({
  ...
  return <div className="space-y-6 sm:space-y-8 relative">
      ...
      <div className="h-28 sm:h-40 w-full flex items-center justify-center relative mb-4 sm:mb-8">
        ...
        <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-full bg-accent-primary/15 absolute flex items-center justify-center">
          <img src="/lovable-uploads/432a0bc4-376f-4766-864d-ff5f206b8068.png" alt="Sound wave" className="w-8 sm:w-10 h-8 sm:h-10 opacity-90 wave-pulse" style={{
      ...
      <div className="space-y-4 pt-2 sm:pt-4">
        <Button className="w-full bg-surface-overlay hover:bg-surface-raised text-text-primary border border-border-subtle shadow-subtle flex items-center justify-center gap-2 sm:gap-3 rounded-xl py-2.5 sm:py-3 text-sm sm:text-base transition-all duration-400" onClick={() => handleSignIn('google')} disabled={signingIn}>
        ...
        <Button onClick={() => handleSignIn('slack')} disabled={signingIn} className="w-full bg-accent-primary text-text-primary flex items-center justify-center gap-2 sm:gap-3 rounded-full transform hover:scale-[1.03] hover:brightness-105 transition-all py-2.5 sm:py-3 text-sm sm:text-base">
