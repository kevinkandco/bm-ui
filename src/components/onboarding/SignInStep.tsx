  ...
  return <div className="space-y-8 relative">
      ...
      <div className="space-y-4 text-center">
        <div className="inline-flex items-center justify-center px-3 py-1 rounded-full text-xs">
          <span className="text-gradient-neon font-medium text-xl">Welcome to Brief.me</span>
        </div>
      ...
      <div className="space-y-4 pt-4">
        <Button className="w-full bg-white/15 hover:bg-white/25 text-off-white border border-white/30 shadow-subtle flex items-center justify-center gap-3 rounded-xl py-3 transition-all duration-400" onClick={() => handleSignIn('google')} disabled={signingIn}>
        ...
        <Button onClick={() => handleSignIn('slack')} disabled={signingIn} className="w-full bg-neon-mint text-forest-green flex items-center justify-center gap-3 rounded-full transform hover:scale-[1.03] hover:brightness-105 transition-all py-3 bg-[#5baeb5]">
          <svg className="w-5 h-5" viewBox="0 0 24 24">
