  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="space-y-4 pt-4">
        ...
        <Button 
          className="w-full bg-neon-mint text-forest-green flex items-center justify-center gap-3 rounded-full transform hover:scale-[1.03] hover:brightness-105 transition-all py-3"
