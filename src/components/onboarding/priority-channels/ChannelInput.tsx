  ...
  return <div className="space-y-2">
      <div className="flex gap-2 relative">
        <div className="relative flex-grow">
          ...
          <Input ref={inputRef} placeholder="Search or add channel (e.g. #marketing)" value={inputValue} onChange={handleSearchChange} onFocus={() => setIsInputFocused(true)} onKeyPress={e => e.key === 'Enter' && addChannel()} className="pl-10 bg-white/15 border-white/20 text-off-white placeholder:text-white/50 h-12" />
        ...
        <Button onClick={addChannel} className="shrink-0 bg-cyan-500 hover:bg-cyan-600 h-12 px-6 rounded-full">
