  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="text-center space-y-2 sm:space-y-3">
        <h2 className="text-xl sm:text-2xl font-semibold text-off-white tracking-tighter">
          How Brief.me works
        </h2>
        ...
        {features.map((_, index) => (
          <div 
            ...
            className={cn(
              ...
              index === currentFeature ? "bg-neon-mint w-4" : "bg-off-white/30 hover:bg-off-white/50"
            )} 
      ...
      <div className="flex justify-between pt-2 sm:pt-4">
        ...
        <Button onClick={nextFeature} className="neon-button text-[#ffffff] bg-teal-500 hover:bg-teal-400 text-sm sm:text-base py-2 sm:py-3 px-4 sm:px-6">
