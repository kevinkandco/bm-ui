...
const FeaturesWalkthroughStep = ({
  ...
  const features = [
    {
      ...
      icon: <Inbox className="h-8 sm:h-10 w-8 sm:w-10 text-accent-blue" />,
    ...
    }, 
    {
      ...
      icon: <Clock className="h-8 sm:h-10 w-8 sm:w-10 text-accent-blue" />,
    ...
    },
    {
      ...
      icon: <UserPlus className="h-8 sm:h-10 w-8 sm:w-10 text-accent-blue" />,
    ...
    }, 
    {
      ...
      icon: <Plane className="h-8 sm:h-10 w-8 sm:w-10 text-accent-blue" />,
  ...
  return <div className="space-y-6 sm:space-y-8">
      ...
      <div className="text-center space-y-2 sm:space-y-3">
        <h2 className="text-xl sm:text-2xl font-semibold text-text-headline tracking-tighter">How Brief-me works</h2>
        <p className="text-sm sm:text-base text-text-body max-w-lg mx-auto">Brief-me helps you stay informed without the information overload.</p>
      </div>
      ...
      <div className="py-4 sm:py-6">
        <div className="feature-display space-y-4 sm:space-y-6">
          ...
          <div className="text-center space-y-2 sm:space-y-3">
            <h3 className="text-lg sm:text-xl font-medium text-text-headline">
              {features[currentFeature].title}
            </h3>
            <p className="text-sm sm:text-base text-text-body">{features[currentFeature].description}</p>
            
            <div className="p-3 sm:p-4 bg-card rounded-lg border border-divider mt-4">
              <p className="text-xs sm:text-sm text-text-body">{features[currentFeature].detail}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-2 pt-2 sm:pt-4">
        {features.map((_, index) => <div key={index} className={cn("w-2 h-2 rounded-full cursor-pointer transition-all", index === currentFeature ? "bg-accent-blue w-4" : "bg-text-secondary hover:bg-text-body")} onClick={() => setCurrentFeature(index)} />)}
      </div>
      ...
      <div className="flex justify-between pt-2 sm:pt-4">
        ...
        <Button onClick={nextFeature} variant="default" size="lg" className="text-sm sm:text-base px-6">
