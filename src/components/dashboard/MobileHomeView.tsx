...
const MobileHomeView = ({
  ...
  return <div className="h-screen max-h-[932px] overflow-y-auto bg-brand-900 relative">
      ...
      <div className="px-6 pt-2 pb-3">
        <SignalSweepBar className="mx-auto w-full max-w-[520px]" height={18} anchors={["#1B5862", "#277F64", "#4FAF83"]} background="transparent" thickness={3} status={userStatus === 'active' ? 'active' : userStatus === 'focus' ? 'focused' : userStatus === 'vacation' ? 'ooo' : 'offline'} />
      </div>
  ...
  Brief Me
        ...
        {/* Brief Card */}
        <div className="bg-brand-600 rounded-xl p-3 border border-border-subtle shadow-none hover:bg-white/5 transition-colors" onClick={() => onOpenBrief(briefData.id)}>
