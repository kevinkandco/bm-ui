      ...
      <div className="w-12 h-full bg-surface/50 backdrop-blur-sm flex flex-col shadow-sm">
        ...
        {!rightPanelCollapsed && (selectedMessage || selectedTranscript || selectedFollowUp) && (
          <>
            ...
            <div className="fixed top-[88px] right-0 w-80 h-[calc(100vh-88px)] bg-surface/95 flex flex-col shadow-2xl rounded-l-xl z-50 transition-transform duration-300 ease-out">
