            ...
            <div className="h-full flex flex-col">
              ...
              <div className="px-6">
                <div className="flex items-center justify-between mb-3 flex ">
                  <h2 onClick={() => navigate('/dashboard')} className="text-text-primary cursor-pointer hover:text-accent-primary text-lg text-left font-medium mx-[10px] mt-[30px] mb-0">Home</h2>
