            ...
            <div className="h-full flex flex-col">
              ...
              <div className="p-4">
                ...
                <Tabs value={leftRailTab} onValueChange={value => setLeftRailTab(value as 'briefs' | 'calendar' | 'followups')} className="w-full border-t border-border-subtle mt-6 pt-4">
                  <TabsList className="flex w-auto bg-surface-raised/30 py-1 pr-1 rounded-lg">
                    <TabsTrigger value="briefs" className="text-text-secondary data-[state=active]:text-text-primary data-[state=active]:bg-surface-raised/70 pl-0 pr-3 py-2 text-base text-left rounded-sm font-medium relative data-[state=active]:after:absolute data-[state=active]:after:bottom-0 data-[state=active]:after:left-0 data-[state=active]:after:right-0 data-[state=active]:after:h-0.5 data-[state=active]:after:bg-green-500 data-[state=active]:after:rounded-full">
                      Briefs
                    </TabsTrigger>
                    <TabsTrigger value="calendar" className="text-text-secondary data-[state=active]:text-text-primary data-[state=active]:bg-surface-raised/70 px-3 py-2 text-base text-left rounded-sm relative data-[state=active]:after:absolute data-[state=active]:after:bottom-0 data-[state=active]:after:left-0 data-[state=active]:after:right-0 data-[state=active]:after:h-0.5 data-[state=active]:after:bg-green-500 data-[state=active]:after:rounded-full">
                      Calendar
                    </TabsTrigger>
                    <TabsTrigger value="followups" className="text-text-secondary data-[state=active]:text-text-primary data-[state=active]:bg-surface-raised/70 px-3 py-2 text-base text-left rounded-sm relative data-[state=active]:after:absolute data-[state=active]:after:bottom-0 data-[state=active]:after:left-0 data-[state=active]:after:right-0 data-[state=active]:after:h-0.5 data-[state=active]:after:bg-green-500 data-[state=active]:after:rounded-full">
                      Follow ups
                    </TabsTrigger>
                  </TabsList>
